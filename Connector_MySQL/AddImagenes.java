...
public class AddImagenes {
    public static final String NOMBRE = "Abigail";
    public static final String CORREO = "Abigail@gmail.com";
    public static final int TEL = 32063250;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            prepereConsulta.setString(2, CORREO);
